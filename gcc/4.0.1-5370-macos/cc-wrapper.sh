...
# Entrypoint — gcc/4.0.1-5370-macos
# cc wrapper — rebrew Apple GCC 4.0.1 build 5370 (macOS).
#
...
_cc1=/opt/gcc-4.0.1-5370/powerpc-darwin-cross/bin/cc1
case "$SRC" in
    *.cpp | *.cc | *.cxx | *.C)
        [ -x /opt/gcc-4.0.1-5370/powerpc-darwin-cross/bin/cc1plus ] && _cc1=/opt/gcc-4.0.1-5370/powerpc-darwin-cross/bin/cc1plus
        ;;
    *) ;;
esac
...
python3 /opt/gcc-4.0.1-5370/convert_gas_syntax.py "$_work/out.s" "$STEM" new > "$_work/out_new.s" \
