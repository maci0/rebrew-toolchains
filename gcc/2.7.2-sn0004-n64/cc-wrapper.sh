...
# Entrypoint — gcc/2.7.2-sn0004-n64
...
/usr/bin/cpp -P "$SRC_ABS" | ( rebrew_run /opt/gcc-2.7.2-sn0004/cc1n64.exe -quiet -G0 -mcpu=vr4300 -mips3 -mhard-float -meb $CC_FLAGS -o out.s ) \
    || rebrew_die "cc1n64 failed on $SRC"
# shellcheck disable=SC2310  # same subshell contract as the cc1n64 stage
( rebrew_run /opt/gcc-2.7.2-sn0004/asn64.exe -q -G0 out.s -o out.obj ) \
    || rebrew_die "asn64 failed on the assembly cc1n64 produced"
/opt/gcc-2.7.2-sn0004/psyq-obj-parser out.obj -o "$OUT_ABS" -b -n
