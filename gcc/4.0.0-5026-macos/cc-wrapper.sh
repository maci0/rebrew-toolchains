...
# Entrypoint — gcc/4.0.0-5026-macos
# cc wrapper — rebrew Apple GCC 4.0.0 build 5026 (macOS).
#
...
_cc1=/opt/gcc-4.0.0-5026/cc1
case "$SRC" in
    *.cpp | *.cc | *.cxx | *.C)
        [ -x /opt/gcc-4.0.0-5026/cc1plus ] && _cc1=/opt/gcc-4.0.0-5026/cc1plus
        ;;
    *) ;;
esac
...
python3 /opt/gcc-4.0.0-5026/convert_gas_syntax.py "$_work/out.s" "$STEM" new > "$_work/out_new.s" \
