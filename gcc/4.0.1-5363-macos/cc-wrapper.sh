...
_cc1=/opt/gcc-4.0.1-5363/cc1
case "$SRC" in
    *.cpp | *.cc | *.cxx | *.C)
        [ -x /opt/gcc-4.0.1-5363/cc1plus ] && _cc1=/opt/gcc-4.0.1-5363/cc1plus
        ;;
    *) ;;
esac
...
python3 /opt/gcc-4.0.1-5363/convert_gas_syntax.py "$_work/out.s" "$STEM" new > "$_work/out_new.s" \
