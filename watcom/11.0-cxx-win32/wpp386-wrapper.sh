#!/bin/sh
# wpp386 wrapper — Watcom C/C++ 11.0 32-bit C++ compiler (Windows PE).
#
...
set -e
rebrew_run /opt/watcom-11.0-cxx/binnt/wpp386.exe \
    -i="Z:\\opt\\watcom-11.0-cxx\\h" -i="Z:\\opt\\watcom-11.0-cxx\\h\\nt" "$@"
