...
# Entrypoint — watcom/10.5a-cxx-win32
# wpp386 wrapper — Watcom C/C++ 10.5a 32-bit C++ compiler (Windows PE).
#
...
set -e
rebrew_run /opt/watcom-10.5a-cxx/binnt/wpp386.exe -i="Z:\\opt\\watcom-10.5a-cxx\\h" -i="Z:\\opt\\watcom-10.5a-cxx\\h\\nt" "$@"
