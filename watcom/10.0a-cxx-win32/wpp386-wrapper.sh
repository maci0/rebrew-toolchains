#!/bin/sh
# wpp386 wrapper — Watcom C/C++ 10.0a 32-bit C++ compiler (Windows PE).
#
...
set -e
rebrew_run /opt/watcom-10.0a-cxx/binnt/wpp386.exe \
    -i="Z:\\opt\\watcom-10.0a-cxx\\h" -i="Z:\\opt\\watcom-10.0a-cxx\\h\\nt" "$@"
