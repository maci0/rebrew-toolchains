#!/bin/sh
# wpp386 wrapper — Watcom C/C++ 10.6 32-bit C++ compiler (Windows PE).
#
...
set -e
rebrew_run /opt/watcom-10.6-cxx/binnt/wpp386.exe \
    -i="Z:\\opt\\watcom-10.6-cxx\\h" -i="Z:\\opt\\watcom-10.6-cxx\\h\\nt" "$@"
